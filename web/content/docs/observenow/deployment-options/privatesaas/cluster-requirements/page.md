...
title: "Requirements"
product: "observenow"
sourcePath: "/observenow/deployment-options/privatesaas/cluster-requirements"
sourceUrl: "https://docs.stackgen.com/observenow/deployment-options/privatesaas/cluster-requirements"
status: "ok"
---

To install StackGen instances onto your own cloud using the `PrivateSaaS` model, a K8s cluster is required on your cloud.
...
- 3 worker nodes (with at least 4 vCPUs and 16GB RAM each)
...
- [Requirements](/docs/observenow/deployment-options/privatesaas/cluster-requirements#requirements)
  - [Cluster Version and Size](/docs/observenow/deployment-options/privatesaas/cluster-requirements#cluster-version-and-size)
- [Cluster creation](/docs/observenow/deployment-options/privatesaas/cluster-requirements#cluster-creation)
  - [AWS](/docs/observenow/deployment-options/privatesaas/cluster-requirements#aws)
  - [GCP](/docs/observenow/deployment-options/privatesaas/cluster-requirements#gcp)
  - [Azure](/docs/observenow/deployment-options/privatesaas/cluster-requirements#azure)
