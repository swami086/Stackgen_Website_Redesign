...
const home: HomeContent = {
    ...
    categories: [
      {
        ...
        items: [
          { name: "AWS", icon: "/logos/integrations/AWS.png" },
          { name: "Azure", icon: "/logos/integrations/Azure.png" },
          { name: "Google Cloud", icon: "/logos/integrations/GoogleCloud.png" },
          { name: "EKS", icon: "/logos/integrations/EKS.png" },
          { name: "AKS", icon: "/logos/integrations/AKS.png" },
          { name: "GKE", icon: "/logos/integrations/GKE.png" },
        ],
      },
      {
        label: "IaC",
        ...
        items: [
          ...
          { name: "OpenTofu", icon: "/logos/integrations/OpenTofu.png" },
          { name: "Helm", icon: "/logos/integrations/Helm.png" },
          {
            name: "CloudFormation",
            icon: "/logos/integrations/CloudFormation.png",
          },
        ],
      },
      {
        ...
        items: [
          ...
          { name: "Bitbucket", icon: "/logos/integrations/Bitbucket.png" },
          { name: "Jenkins", icon: "/logos/integrations/Jenkins.png" },
          { name: "Argo CD", icon: "/logos/integrations/ArgoCD.png" },
        ],
      },
      {
        label: "Observability",
        ...
        items: [
          { name: "Grafana", icon: "/logos/integrations/Grafana.png" },
          { name: "Prometheus", icon: "/logos/integrations/Prometheus.png" },
          { name: "Loki", icon: "/logos/integrations/Loki-v2.png" },
          { name: "Jaeger", icon: "/logos/integrations/Jaeger.png" },
          {
            name: "OpenTelemetry",
            icon: "/logos/integrations/OpenTelemetry.png",
          },
          { name: "Datadog", icon: "/logos/integrations/Datadog.png" },
          { name: "New Relic", icon: "/logos/integrations/NewRelic.png" },
        ],
      },
      {
        ...
        items: [
          { name: "Wiz", icon: "/logos/integrations/Wiz-icon.png" },
          {
            name: "HashiCorp Vault",
            icon: "/logos/integrations/HashiCorpVault.png",
          },
          { name: "Okta", icon: "/logos/integrations/Okta.png" },
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "ServiceNow",
            icon: "/logos/integrations/ServiceNow-icon-v2.png",
          },
      ...
      },
      {
        ...
        items: [
          { name: "VS Code", icon: "/logos/integrations/VSCode.png" },
          { name: "Cursor", icon: "/logos/integrations/Cursor-icon.png" },
          { name: "Amazon Kiro", icon: "/logos/integrations/Kiro.png" },
          { name: "Claude Code", icon: "/logos/integrations/Claude-icon.png" },
          { name: "Backstage", icon: "/logos/integrations/Backstage.png" },
        ],
      },
    ],
  },
  ...
  compliance: {
    ...
    badges: [
      { label: "SOC 2", icon: "/logos/compliance/SOC2-badge.png" },
      { label: "PCI", icon: "/logos/compliance/PCI-SSC-badge.png" },
      { label: "HIPAA", icon: "/logos/compliance/HIPAA-badge.png" },
    ],
  },
