...
product: "aiden"
sourcePath: "/aiden/integrations/gcp"
sourceUrl: "https://docs.stackgen.com/aiden/integrations/gcp"
status: "ok"
---

This unversioned path redirects to the Aiden 1.0 documentation. See the [Aiden 1.0 GCP integration](/docs/aiden/1.0/integrations/gcp) page.
