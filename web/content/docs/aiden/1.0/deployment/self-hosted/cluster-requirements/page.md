...
title: "Prerequisites"
product: "aiden"
sourcePath: "/aiden/1.0/deployment/self-hosted/cluster-requirements"
sourceUrl: "https://docs.stackgen.com/aiden/1.0/deployment/self-hosted/cluster-requirements"
status: "ok"
---
...
Self-hosted deployment on GCP (GKE) or Azure (AKS) requires additional setup and configuration. Please contact your StackGen Customer Success representative to enable self-hosted deployment access for your GCP or Azure account before proceeding with the deployment.

## AWS (EKS) Cluster Configuration [](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#aws-eks-cluster-configuration%20%22Direct%20link%20to%20AWS%20(EKS) Cluster Configuration")

The following section provides step-by-step instructions and Terraform examples for configuring an Amazon EKS cluster for Aiden self-hosted deployment.
...
- [Prerequisites](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#prerequisites)
  - [Cluster Version and Size](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#cluster-version-and-size)
  - [Cluster Resources and Configurations](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#cluster-resources-and-configurations)
- [Supported Cloud Providers](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#supported-cloud-providers)
- [AWS (EKS) Cluster Configuration](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#aws-eks-cluster-configuration)
  - [VPC Configuration](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#vpc-configuration)
  - [S3 Bucket Configuration](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#s3-bucket-configuration)
  - [IAM Role Creation](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#iam-role-creation)
  - [IAM Policy Configuration](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#iam-policy-configuration)
  - [EKS Cluster Creation](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#eks-cluster-creation)
  - [Post-Deployment Information](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#post-deployment-information)
- [Deployment Options](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#deployment-options)
  - [Option 1: Using Existing VPC and Subnets](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#option-1-using-existing-vpc-and-subnets)
  - [Option 2: Creating New VPC and Subnets](/docs/aiden/1.0/deployment/self-hosted/cluster-requirements#option-2-creating-new-vpc-and-subnets)
