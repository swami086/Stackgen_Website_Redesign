...
product: "aiden"
sourcePath: "/aiden/integrations/jenkins"
sourceUrl: "https://docs.stackgen.com/aiden/integrations/jenkins"
status: "ok"
---

This unversioned path redirects to the Aiden 1.0 documentation. See the [Aiden 1.0 Jenkins integration](/docs/aiden/1.0/integrations/jenkins) page.
